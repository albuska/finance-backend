 ...
 const user = await db.query('SELECT * FROM users WHERE email = $1', [email]);
  ...
  const verifyEmail = {
    ...
    <div style="text-align: center;">
      ...
      <a href="${BASE_URL}/api/verify/${user.verificationToken}" style="display: inline-block; padding: 10px 20px; background-color: #007BFF; color: #fff; text-decoration: none;">Verify Email</a>
    </div>
  `,
  };
